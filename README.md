...
3. for winpwn-nodeps: written by myself. It just use ctypes to invoke Windows API. It supports python2.7 and python3, and you can <b>use pip to install winpwn-nodeps</b>
